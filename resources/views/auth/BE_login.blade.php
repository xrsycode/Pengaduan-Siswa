...
@section('title', 'Login | Layanan Pengaduan SMK Telkom Purwokerto')
@section('content')
        ...
        <div class="flex flex-col items-center md:flex-row">
            ...
            <div class="w-full mt-16 md:mt-0 md:w-2/5">
                <div
                    ...
                    <h3 class="mb-6 text-2xl font-medium text-center">Login Pengaduan <br> <strong>SMA Muhammadiyah 1 Cilacap</strong>
                    </h3>
                    <form action="{{ route('proses.login') }}" method="post">
                        ...
                        <div class="block mb-4 border border-gray-200 rounded-lg">
                            <input type="text" name="email" id="email"
                                ...
                                placeholder="Masukan Nomor NIS Anda">
                        </div>
                        <div class="block mb-4 border border-gray-200 rounded-lg">
                        ...
                        <div class="block">
                            <button
                                class="w-full px-3 py-4 font-medium font-semibold font-medium text-white bg-green-700 rounded-lg">Login</button>
                        </div>
                    </form>
                </div>
            </div>
        ...
        <div class="row h-100">
            <div class="col-lg-5 col-12">
                <div id="auth-left">
                    ...
                    <p class="auth-subtitle mb-5">Selamat Datang di Sistem Pengaduan Sekolah <strong>SMK Telkom Purwokerto</strong></p>
