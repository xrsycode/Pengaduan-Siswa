...
@section('title', 'Detail Pengaduan | SMK Telkom Purwokerto')
@section('content')
    <!---form -->
            ...
            <div class="w-full px-6  py-6 mx-auto mt-10 shadow-2xl bg-white border border-gray-200 rounded-lg sm:px-8 md:px-12 sm:py-8 sm:shadow-2xl lg:w-5/6 xl:w-2/3">
              ...
              <p class="mt-2 text-base text-gray-600 sm:text-lg md:text-normal">{{$groupItem->pengaduan->laporan}}</p>
                ...
                <div class="block">
                  ...
                  class="inline-flex items-center w-full px-6 py-3 text-sm font-medium leading-4 text-white transition duration-150 ease-in-out bg-transparent bg-red-700 border border-transparent md:px-3 md:w-auto md:rounded-md mt-5 lg:px-5 hover:bg-red-700 focus:outline-none focus:border-indigo-700 focus:shadow-outline-indigo active:bg-indigo-700">kembali</a>
                </div>
            </div>
              <!-- card report -->
        </div>
