...
@section('title', 'Pengaduan Sekolah SMA Muhammadiyah')

@section('content')
   <!-- hero section -->
   ikon judul halaman laravel 10
        ...
        <div class="order-1 w-full px-3 lg:w-1/2 lg:order-0">
          <div class="w-full lg:max-w-md">
            <h2
              ...
              Selamat Datang di Sistem Layanan Pengaduan Siswa / Siswi SMA Muhammadiyah 1 Cilacap</h2>
              <p class="mb-4 font-medium tracking-tight text-gray-400 lg:text-left md:text-center  xl:mb-6">Laporkan
                kepada kami jika ada
                Pengaduan yang dapat menjadi langkah awal untuk kita menjadi lebih baik lagi.</p>
              <div class="relative flex flex-col sm:flex-row  sm:space-x-4">
               <a href="#"
                ...
                <a href="{{url('site/buat-pengaduan')}}"
                  class="flex items-center w-full  px-6 py-3 mt-2 mb-3 text-md text-white bg-green-700 rounded-md sm:mb-0 hover:bg-green-800 sm:w-auto">
                  Buat Pengaduan
  ...
  <path fill="#047857" fill-opacity="1" d="M0,160L60,160C120,160,240,160,360,176C480,192,600,224,720,218.7C840,213,960,171,1080,149.3C1200,128,1320,128,1380,128L1440,128L1440,320L1380,320C1320,320,1200,320,1080,320C960,320,840,320,720,320C600,320,480,320,360,320C240,320,120,320,60,320L0,320Z"></path>
</svg>
  </section>
  <!-- end hero section -->
  ...
  <section class="relative py-20 bg-white min-w-screen animation-fade animation-delay" id="about">
    <div class="container px-0 px-8 mx-auto sm:px-12 xl:px-5">
      <h4
        ...
        Sekilas Mengenai Aplikasi Pengaduan SMA Muhammadiyah 01</h4>
      ...
      <div
        ...
        <h3 class="text-lg font-bold text-red-700 sm:text-xl md:text-2xl">Untuk Apa sistem ini di buat?</h3>
  ...
  <section class="relative py-16 bg-white min-w-screen animation-fade animation-delay" id="faq">
    <div class="container px-0 px-8 mx-auto sm:px-12 xl:px-5">
      ...
      <div
        class="w-full px-6 py-6 mx-auto mt-10 bg-white border border-gray-200 rounded-lg sm:px-8 md:px-12 sm:py-8 sm:shadow lg:w-5/6 xl:w-2/3">
        <h3 class="text-lg font-bold text-red-700 sm:text-xl md:text-2xl">Apakah Aplikasi Pengaduan SMA Muhammadiyah ini ?</h3>
        <p class="mt-2 text-base text-gray-600 sm:text-lg md:text-normal">Lorem ipsum dolor, sit amet consectetur
      ...
      <div
        class="w-full px-6 py-6 mx-auto mt-10 bg-white border border-gray-200 rounded-lg sm:px-8 md:px-12 sm:py-8 sm:shadow lg:w-5/6 xl:w-2/3">
        <h3 class="text-lg font-bold text-red-700 sm:text-xl md:text-2xl">Apakah bentuk respon yang diberikan
          kepada
      ...
      <div
        class="w-full px-6 py-6 mx-auto mt-10 bg-white border border-gray-200 rounded-lg sm:px-8 md:px-12 sm:py-8 sm:shadow lg:w-5/6 xl:w-2/3">
        <h3 class="text-lg font-bold text-red-700 sm:text-xl md:text-2xl">Berapa lama respon atas pengaduan yang
      ...
      <div
        class="w-full px-6 py-6 mx-auto mt-10 bg-white border border-gray-200 rounded-lg sm:px-8 md:px-12 sm:py-8 sm:shadow lg:w-5/6 xl:w-2/3">
        <h3 class="text-lg font-bold text-red-700 sm:text-xl md:text-2xl">Apakah pengaduan yang saya berikan akan
